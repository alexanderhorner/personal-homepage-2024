import Portfolio2022Screenshot from "~/assets/images/portfolio-2022.png"
import Portfolio2022ContactScreenshot from "~/assets/images/portfolio-2022-contact.png"
...
export const img = Portfolio2022Screenshot

# {title}

<a href="https://personal-homepage2022.web.app" target="_blank" rel="noopener noreferrer">
  <img src={Portfolio2022Screenshot} alt="Screenshot of 2022 Portfolio" />
</a>
...
<img src={Portfolio2022ContactScreenshot} alt="Screenshot of Contact Form" />
