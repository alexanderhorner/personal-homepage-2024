import PortfolioScreenshot from "~/assets/images/alexander-horner-com-thumbnail.png"
import PortfolioDialog from "~/assets/images/this-portfolio-dialog.png"
...
export const img = PortfolioScreenshot


# {title}

<img src={PortfolioScreenshot} alt="Screenshot of Portfolio" />
...
<img src={PortfolioDialog} alt="Screenshot of Portfolio Modal" />
...
Images are optimized automatically at build time and loaded lazily to improve performance. 